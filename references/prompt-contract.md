...
画面过满或只剩“电影感”形容词时，保留一个第一眼叙事单元、一层低对比支持信息和一块有叙事用途的安静区域；不能仅凭形状、明暗和遮挡辨认主体关系时继续删减。过曝、欠曝、雾、反射、剪影或前景遮挡都要有物理来源和叙事用途。

用户指定模型或要求转译时，保留六项决策，只按目标工具已核实的能力调整长度、画幅、参考图和编辑方式。工具参数放在提示词外；不编造权重语法、版本能力或画质提升。
